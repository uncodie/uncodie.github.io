...
<?php
	...
	$insert=mysqli_query($conn,"INSERT INTO visit_desktop (dt,dtime) VALUES ('$dt','$dtime')");
?>		
 ...
 <!--start-home-->
	<div id="skrollr-body">
		...
		<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="337px" height="200px" >
			...
			<div id="copyright" style="font-size:10px;">Design by <div id="ipaddress"></div>&nbsp;<a href="https://www.youtube.com/channel/UC8OV-4MqjmqyEbS_HRILcXw" target="_blank"><img src="images/m.logo.gif" height="25" style="margin-bottom:-5px;"></a> </div>
